...
MANDATORY RESEARCH: Before generating project ideas, read skills/azure-ai-research/SKILL.md and fetch the current model catalog and Foundry platform documentation. Your ideas must reference current Azure services and AI models (not stale training data). Use Microsoft Foundry as the AI platform (not standalone Azure OpenAI resources), recommend current model families, and reference Microsoft Agent Framework for agent-based solutions.
